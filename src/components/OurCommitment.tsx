...
const OurCommitment = () => {
  ...
  return (
    <section ref={ref} className="w-full py-20 lg:py-28 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 lg:px-14">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-[2.8rem] font-bold uppercase tracking-[0.08em] text-foreground">
            Our Commitment
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 lg:gap-8">
          {commitments.map((item, index) => (
            <motion.div
              ...
              className="corporate-card rounded-xl p-6 md:p-8 flex flex-col items-center justify-start text-center"
            >
              <div className="h-20 md:h-24 w-full max-w-[120px] flex items-center justify-center mb-5 bg-white rounded-lg p-2 border border-border/40">
                <img
                  src={item.logo}
                  alt={item.title}
